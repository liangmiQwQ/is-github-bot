# `is-github-bot` Website

Build a static website with Vue3, TypeScript, UnoCSS and https://void.cloud/, run `isGitHubBot` on the user's local computer.

## Design

Use flex, center layout as basically layout. Use `slate` as primary color.
